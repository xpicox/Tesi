...
%The FFI implements the C calling convection but does not support structured types passed by value.

\todo{Stable pointers to pass haskell objects to C}
\todo{Foreign Pointers add finalization support for haskell references to external objects}